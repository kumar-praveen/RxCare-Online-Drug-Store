...
const Login = () => {
  ...
  const { setShowUserLogin, setUser, user, axios } = useAppContext();
  ...
  return (
    <div
      ...
      className="fixed top-0 bottom-0 left-0 right-0 z-30 flex items-center text-sm text-gray-500 bg-black/50"
    >
      <form
      ...
      >
        <p className="text-2xl font-medium m-auto">
          <span className="text-primary-dull">User</span>{" "}
